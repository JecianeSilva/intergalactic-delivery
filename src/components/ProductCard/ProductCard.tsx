...
export function ProductCard({ product, className, ...rest }: ProductCardProps) {
  ...
  return (
    <div
      className={`flex flex-col border border-slate-100 justify-between w-64 h-[350px] bg-white shadow-md rounded-tl-xs rounded-tr-[1.75rem] rounded-br-xs rounded-bl-[1.75rem] flex flex-col items-center py-6 px-3 ${className} max-[600px]:w-full`}
      {...rest}
    >
